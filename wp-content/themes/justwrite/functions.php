...
if ( ! function_exists( 'ac_css_files' ) ) {  
	...
	function ac_css_files() {
		...
		// Enqueue
		wp_enqueue_style( 'ac_style', get_stylesheet_uri(), array(), '1.0.6', 'all' );
		wp_enqueue_style( 'ac_icons', get_template_directory_uri() . '/assets/icons/css/font-awesome.min.css', array(), '4.1.0', 'all' );
